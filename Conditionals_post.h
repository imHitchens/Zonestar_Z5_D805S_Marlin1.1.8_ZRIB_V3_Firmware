...
#define CONDITIONALS_POST_H
   ...
   */
	  ...
	  #elif Z2_USE_ENDSTOP == _Z2MIN_
        #define Z2_MAX_ENDSTOP_INVERTING Z_MAX_ENDSTOP_INVERTING
        #define Z2_MAX_PIN Z2_SW_PIN
      #else
  ...
  #define HAS_FIL_RUNOUT3 (((EXTRUDERS > 2) || ENABLED(MIXING_3_IN_1_OUT)) && PIN_EXISTS(FIL_RUNOUT3))
