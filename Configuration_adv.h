...
//#define FWRETRACT  // ONLY PARTIALLY TESTED
  ...
  #define MAX_AUTORETRACT 	  16.0          // Upper limit for auto-retract conversion
  #define RETRACT_LENGTH  	  10            // Default retract length (positive mm)
  #define RETRACT_LENGTH_SWAP 13          	// Default swap retract length (positive mm), for extruder change
  #define RETRACT_FEEDRATE    30            // Default feedrate for retracting (mm/s)
  #define RETRACT_ZLIFT 	  1             // Default retract Z-lift
